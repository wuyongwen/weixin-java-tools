...
public interface WxMpService {
	 ...
	 *            媒体类型, 请看{@link me.chanjar.weixin.common.api.WxConsts}
	 * @param material
	 *            上传的素材, 请看{@link me.chanjar.weixin.mp.bean.WxMpMaterial}
	 * @return
	 * @throws WxErrorException
	 */
	 ...
	 * 
	 * @param news
	 *            上传的图文消息, 请看{@link me.chanjar.weixin.mp.bean.WxMpMaterialNews}
	 * @return
	 * @throws WxErrorException
	 */
	 ...
	 *            用来更新图文素材的bean, 请看
	 *            {@link me.chanjar.weixin.mp.bean.WxMpMaterialArticleUpdate}
	 * @return
	 * @throws WxErrorException
	 */
	 ...
	 * 
	 * @param scene_id
	 *            参数。永久二维码时最大值为100000（目前参数只支持1--100000）
	 * @return
	 * @throws WxErrorException
	 */
	 ...
	 * @return
	 * @deprecated Use
	 *             me.chanjar.weixin.mp.api.WxMpService.getPrepayId(Map<String,
	 *             String>) instead
	 */
	@Deprecated
	WxMpPrepayIdResult getPrepayId(String openId, String outTradeNo, double amt, String body, String tradeType,
	 ...
	 *            通知地址
	 * @return
	 * @deprecated Use me.chanjar.weixin.mp.api.WxMpService.getJSSDKPayInfo(Map<
	 *             String, String>) instead
	 */
	@Deprecated
	Map<String, String> getJSSDKPayInfo(String openId, String outTradeNo, double amt, String body, String tradeType,
			String ip, String notifyUrl);
