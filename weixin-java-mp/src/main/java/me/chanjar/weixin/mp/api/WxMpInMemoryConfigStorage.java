...
public class WxMpInMemoryConfigStorage implements WxMpConfigStorage {
	...
	public String toString() {
		return "WxMpInMemoryConfigStorage{" + "appId='" + appId + '\'' + ", secret='" + secret + '\'' + ", token='"
				+ token + '\'' + ", partnerId='" + partnerId + '\'' + ", partnerKey='" + partnerKey + '\''
				...
				+ ", http_proxy_username='" + http_proxy_username + '\'' + ", http_proxy_password='"
				+ http_proxy_password + '\'' + ", jsapiTicket='" + jsapiTicket + '\'' + ", jsapiTicketExpiresTime='"
				+ jsapiTicketExpiresTime + '\'' + ", tmpDirFile='" + tmpDirFile + '\'' + '}';
	}
	...
	@Override
	public void updateAccessToken(HttpHost httpProxy, CloseableHttpClient httpClient) throws WxErrorException {
		synchronized (WxMpInMemoryConfigStorage.class) {
			if (isAccessTokenExpired()) {
				String url = "https://api.weixin.qq.com/cgi-bin/token?grant_type=client_credential" + "&appid="
						+ getAppId() + "&secret=" + getSecret();
				try {
